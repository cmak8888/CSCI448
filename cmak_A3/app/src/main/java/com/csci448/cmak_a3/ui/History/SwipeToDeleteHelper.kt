...
class SwipeToDeleteHelper(private val adapter: HistoryAdapter) : ItemTouchHelper.Callback() {
    ...
    override fun onChildDraw(c: Canvas, recyclerView: RecyclerView, viewHolder: RecyclerView.ViewHolder,
        ...
        if( dX > horizontalMargin + iconSize ) {
            ...
            c.drawText(context.resources.getString(R.string.delete_location_label),
